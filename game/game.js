...
class CyberbullyingGame {
        ...
        this.scenarios = [
            {
                ...
                escalation: [
                    ...
                    ["Защо си толкова бавен/а?", "Мразя да чакам!"],
                    ["Отговаряй веднага!", "Не съм те питал дали имаш време!"]
                ],
                choices: [
                    { text: "Отговарям учтиво и обяснявам, че съм зает/а", type: "good", points: 10 },
            ...
            },
            {
                ...
                bullyMessages: [
                    ["Виждам снимките ти", "Много си грозен/а"],
                    ["Погледнах профила ти", "Жалък/а си"],
                    ["Видях как изглеждаш", "Отвратителен/а си"]
                ],
                escalation: [
                    ["Всички се смеят на теб", "Нищожество си"],
                    ["Никой не те харесва", "Загубеняк си"],
                    ["Всички говорят колко си странен/а", "Никой не ще да е с теб"]
                ],
                choices: [
            ...
            },
            {
                ...
                escalation: [
                    ["Ще кажа на всички какъв/а си", "Ще публикувам снимки"],
            ...
            },
            {
                ...
                bullyMessages: [
                    ...
                    ["Публикувах за теб", "Станал/а си известен/а"]
                ],
                escalation: [
                    ["Създадох фалшив профил за теб", "Всички ще те мразят"],
                    ["Пуснах слухове", "Никой няма да ти вярва"],
                    ["Всички ще знаят колко си лош/а", "Ще те изгонят отвсякъде"]
                ],
                choices: [
    ...
    resetGame() {
        ...
        this.updateAvatarStatus('player', 'готов/а за игра');
    ...
    selectChoice(choice) {
        ...
        setTimeout(() => {
            const reactions = {
                good: [
                    'Ти си много досаден/а',
                    'Не си заслужаваш времето ми',
                    'Бъди си така скучен/а'
                ],
                bad: [
